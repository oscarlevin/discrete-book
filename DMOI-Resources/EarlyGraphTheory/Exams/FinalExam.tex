...
\firstpageheader{Math 228}{\bf\large Final Exam}{December 6, 2018}
...
\begin{questions}
	...
	\begin{parts}
		...
		\vfill
		\part[4] In fact, the original statement is true.  \underline{Use this} to prove that the following two graphs are NOT isomorphic.  You should draw out the graphs as a first step.  You must use the statement above in your proof.
		\[G_1: V_1 = \{a,b,c,d,e\}, E_1 = \{ab, ac, ad, ae, bc, cd, de\} \]
		\[G_2: V_1 = \{u, v, w, x, y\}, E_2 = \{uv, uw, ux, vw, vx, wx, wy\}\]
		\vfill
		\vfill
		\vfill
	...
	\begin{parts}
		...
		\end{solution}
		\vfill
		\part[4] Suppose $G$ is a $6$-regular graph. Must the chromatic number of $G$ be at least 6?  Explain.
		\begin{solution}
...
\begin{parts}
	\part One of your friends mistakenly thinks the answer should be $P(100,5)$.  Explain why this is wrong by explicitly referencing outcomes your friend is over or under counting.
	\begin{solution}
...
\begin{parts}
	...
	\end{solution}
	\vfill
	\part How many 5-letter words can you make from the letters $\{a, b, c, d, e, f, g\}$ without using any letter more than once?
	\begin{solution}
	...
	\end{solution}
	\vfill
	\part How many ways are there to divide 15 students into three named groups of 5?
	\begin{solution}
