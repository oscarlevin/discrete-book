...
\resizebox{.6\linewidth}{!}{\scshape Elelments of}

\vskip -1ex

\resizebox{.9\linewidth}{!}{\scshape Discrete Mathematics}
...
\resizebox{.75\linewidth}{!}{\scshape An Open Introduction for Teachers}
