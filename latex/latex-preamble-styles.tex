...
\end{mdframed}
% \vspace{-4em} \begin{center}\colorbox{white}{%
%  \space\space\quad {\LARGE \color{red} \Stopsign} \quad \textbf{\footnotesize Attempt the above activity before proceeding} \quad {\LARGE\color{red} \Stopsign}\quad\space\space 
%  }  \end{center}\par
% \end{center}
}
