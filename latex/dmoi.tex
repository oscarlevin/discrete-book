...
\begin{enumerate}
\item\hypertarget{li-368}{}\(f:\Z \to \Z\) defined by \(f(n) = 3n\). The domain and codomain are both the set of integers. However, the range is only the set of integer multiples of 3.%
\item\hypertarget{li-369}{}\(g: \{1,2,3\} \to \{a,b,c\}\) defined by \(g(1) = c\), \(g(2) = a\) and \(g(3) = a\). The domain is the set \(\{1,2,3\}\), the codomain is the set \(\{a,b,c\}\) and the range is the set \(\{a,c\}\). Note that \(g(2)\) and \(g(3)\) are the same element of the codomain. This is okay since each element in the domain still has only one output.%
\item\hypertarget{li-370}{}\hypertarget{p-547}{}%
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-371}{}\(f:\Z \to \Z\) defined by \(f(n) = 3n\).%
\item\hypertarget{li-372}{}\(g: \{1,2,3\} \to \{a,b,c\}\) defined by \(g = \begin{pmatrix}1 \amp 2 \amp 3 \\ c \amp a \amp a \end{pmatrix}\).%
\item\hypertarget{li-373}{}\hypertarget{p-563}{}%
\(h:\{1,2,3\} \to \{1,2,3\}\) defined as follows:%
% group protects changes to lengths, releases boxes (?)
{% begin: group for a single side-by-side
% set panel max height to practical minimum, created in preamble
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-374}{}\(f\) is not surjective. There are elements in the codomain which are not in the range. For example, no \(n \in \Z\) gets mapped to the number 1 (the rule would say that \(\frac{1}{3}\) would be sent to 1, but \(\frac{1}{3}\) is not in the domain). In fact, the range of the function is \(3\Z\) (the integer multiples of 3), which is not equal to \(\Z\).%
\item\hypertarget{li-375}{}\(g\) is not surjective. There is no \(x \in \{1,2,3\}\) (the domain) for which \(g(x) = b\), so \(b\), which is in the codomain, is not in the range. Notice that there is an element from the codomain ``missing'' from the bottom row of the matrix.%
\item\hypertarget{li-376}{}\(h\) is surjective. Every element of the codomain is also in the range. Nothing in the codomain is missed.%
\end{enumerate}
%
\end{example}
\hypertarget{p-565}{}%
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-377}{}\(f:\Z \to \Z\) defined by \(f(n) = 3n\).%
\item\hypertarget{li-378}{}\(g: \{1,2,3\} \to \{a,b,c\}\) defined by \(g = \begin{pmatrix}1 \amp 2 \amp 3 \\ c \amp a \amp a \end{pmatrix}\).%
\item\hypertarget{li-379}{}\hypertarget{p-569}{}%
\(h:\{1,2,3\} \to \{1,2,3\}\) defined as follows:%
% group protects changes to lengths, releases boxes (?)
{% begin: group for a single side-by-side
% set panel max height to practical minimum, created in preamble
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-380}{}\(f\) is injective. Each element in the codomain is assigned to at \emph{most} one element from the domain. If \(x\) is a multiple of three, then only \(x/3\) is mapped to \(x\). If \(x\) is not a multiple of 3, then there is no input corresponding to the output \(x\).%
\item\hypertarget{li-381}{}\(g\) is not injective. Both inputs \(2\) and \(3\) are assigned the output \(a\). Notice that there is an element from the codomain that appears more than once on the bottom row of the matrix.%
\item\hypertarget{li-382}{}\(h\) is injective. Each output is only an output once.%
\end{enumerate}
%
\end{example}
\hypertarget{p-571}{}%
...
\begin{assemblage}[Injective vs Surjective]\label{assemblage-12}
\hypertarget{p-573}{}%
...
%
\end{example}
\begin{assemblage}[Function Definitions]\label{assemblage-13}
\hypertarget{p-589}{}%
%
\begin{itemize}[label=\textbullet]
\item{}\hypertarget{p-590}{}%
...
\leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-401}{}\hypertarget{p-613}{}%
\(f = \twoline{1 \amp 2 \amp 3 \amp 4 \amp 5}{3 \amp 3 \amp 3 \amp 3 \amp 3}\). (Choose one: )%
\item\hypertarget{li-402}{}\hypertarget{p-614}{}%
\(f = \twoline{1 \amp 2 \amp 3 \amp 4 \amp 5}{2 \amp 3 \amp 1 \amp 5 \amp 4}\). (Choose one: )%
\item\hypertarget{li-403}{}\hypertarget{p-615}{}%
\(f(x) = 6 - x\).  (Choose one: )%
\item\hypertarget{li-404}{}\hypertarget{p-616}{}%
\(f(x) = \begin{cases} x/2 \amp \text{ if } x \text{ is even} \\ (x+1)/2 \amp \text{ if } x \text{ is odd}\end{cases}\). (Choose one: )%
\end{enumerate}
%
\par
\medskip\noindent%
\textbf{Solution.}\quad \hypertarget{p-617}{}%
\leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-405}{}\hypertarget{p-618}{}%
...
\item\hypertarget{li-408}{}\hypertarget{p-621}{}%
...
\item\hypertarget{li-413}{}\hypertarget{p-629}{}%
...
\item\hypertarget{li-414}{}\hypertarget{p-630}{}%
...
\leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-415}{}\hypertarget{p-633}{}%
\(f = \twoline{1 \amp 2 \amp 3 \amp 4}{1 \amp 2 \amp 5 \amp 4}\). (Choose one: )%
\item\hypertarget{li-416}{}\hypertarget{p-634}{}%
\(f = \twoline{1 \amp 2 \amp 3 \amp 4}{1 \amp 2 \amp 3 \amp 2}\). (Choose one: )%
\item\hypertarget{li-417}{}\hypertarget{p-635}{}%
...
\par
\medskip\noindent%
\textbf{Solution.}\quad \hypertarget{p-636}{}%
\leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-418}{}\hypertarget{p-637}{}%
...
\item\hypertarget{li-419}{}\hypertarget{p-638}{}%
...
\item\hypertarget{li-420}{}\hypertarget{p-639}{}%
...
\begin{exerciselist}
\item[1.]\hypertarget{exercise-47}{}\hypertarget{p-640}{}%
...
\par\smallskip
\item[2.]\hypertarget{exercise-48}{}\hypertarget{p-642}{}%
...
\par\smallskip
\item[3.]\hypertarget{exercise-49}{}\hypertarget{p-644}{}%
...
\leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-421}{}\hypertarget{p-646}{}%
Is \(f\) injective? Explain.%
\item\hypertarget{li-422}{}\hypertarget{p-647}{}%
Is \(f\) surjective? Explain.%
\item\hypertarget{li-423}{}\hypertarget{p-648}{}%
Write the function using two-line notation.%
\end{enumerate}
%
\par\smallskip
\item[4.]\hypertarget{exercise-50}{}\hypertarget{p-653}{}%
...
Is \(f\) injective? Explain.%
\item\hypertarget{li-428}{}\hypertarget{p-656}{}%
Is \(f\) surjective? Explain.%
...
%
\par\smallskip
\item[5.]\hypertarget{exercise-51}{}\hypertarget{p-662}{}%
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-433}{}\(f:\N \to \N\) given by \(f(n) = n+4\).%
\item\hypertarget{li-434}{}\(f:\Z \to \Z\) given by \(f(n) = n+4\).%
\item\hypertarget{li-435}{}\(f:\Z \to \Z\) given by \(f(n) = 5n - 8\).%
\item\hypertarget{li-436}{}\(f:\Z \to \Z\) given by \(f(n) = \begin{cases}n/2 \amp  \text{ if } n \text{ is even} \\ (n+1)/2 \amp \text{ if } n \text{ is odd} . \end{cases}\)%
\end{enumerate}
%
\par\smallskip
\item[6.]\hypertarget{exercise-52}{}\hypertarget{p-664}{}%
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-441}{}\hypertarget{p-665}{}%
Is \(f\) injective? Prove your answer.%
\item\hypertarget{li-442}{}\hypertarget{p-666}{}%
Is \(f\) surjective? Prove your answer.%
\item\hypertarget{li-443}{}\hypertarget{p-667}{}%
Find \(f\inv(1)\).%
\item\hypertarget{li-444}{}\hypertarget{p-668}{}%
Find \(f\inv(0)\).%
\item\hypertarget{li-445}{}\hypertarget{p-669}{}%
Find \(f\inv(12)\).%
\end{enumerate}
%
\par\smallskip
\item[7.]\hypertarget{exercise-53}{}\hypertarget{p-676}{}%
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-451}{}\hypertarget{p-677}{}%
Find \(f\inv(3)\).%
\item\hypertarget{li-452}{}\hypertarget{p-678}{}%
Find \(f\inv(28)\).%
\item\hypertarget{li-453}{}\hypertarget{p-679}{}%
Is \(f\) injective. Explain.%
\item\hypertarget{li-454}{}\hypertarget{p-680}{}%
Is \(f\) surjective. Explain.%
\end{enumerate}
%
\par\smallskip
\item[8.]\hypertarget{exercise-54}{}\hypertarget{p-684}{}%
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-459}{}\hypertarget{p-685}{}%
Find \(f\inv(2)\).%
\item\hypertarget{li-460}{}\hypertarget{p-686}{}%
Give a geometric description of \(f\inv(n)\) for any \(n \ge 1\).%
\item\hypertarget{li-461}{}\hypertarget{p-687}{}%
Find a formula for \(|f\inv(n)|\) in terms of \(n\).%
\end{enumerate}
%
\par\smallskip
\item[9.]\hypertarget{exercise-55}{}\hypertarget{p-692}{}%
Let \(f:X \to Y\) be some function. Suppose \(3 \in Y\). What can you say about \(f\inv(3)\) if you know, \leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-465}{}\hypertarget{p-693}{}%
\(f\) is injective? Explain.%
\item\hypertarget{li-466}{}\hypertarget{p-694}{}%
\(f\) is surjective? Explain.%
\item\hypertarget{li-467}{}\hypertarget{p-695}{}%
\(f\) is bijective? Explain.%
\end{enumerate}
%
\par\smallskip
\item[10.]\hypertarget{exercise-56}{}\hypertarget{p-700}{}%
Find a set \(X\) and a function \(f:X \to \N\) so that \(f\inv(0) \cup f\inv(1) = X\).%
\par\smallskip
\item[11.]\hypertarget{exercise-57}{}\hypertarget{p-702}{}%
What can you deduce about the sets \(X\) and \(Y\) if you know \textellipsis{} \leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-471}{}\hypertarget{p-703}{}%
there is an injective function \(f:X \to Y\)? Explain.%
\item\hypertarget{li-472}{}\hypertarget{p-704}{}%
there is a surjective function \(f:X \to Y\)? Explain.%
\item\hypertarget{li-473}{}\hypertarget{p-705}{}%
there is a bijectitve function \(f:X \to Y\)? Explain.%
\end{enumerate}
%
\par\smallskip
\item[12.]\hypertarget{exercise-58}{}\hypertarget{p-710}{}%
Suppose \(f:X \to Y\) is a function. Which of the following are possible? Explain. \leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-477}{}\(f\) is injective but not surjective.%
\item\hypertarget{li-478}{}\(f\) is surjective but not injective.%
\item\hypertarget{li-479}{}\(|X| = |Y|\) and \(f\) is injective but not surjective.%
\item\hypertarget{li-480}{}\(|X| = |Y|\) and \(f\) is surjective but not injective.%
\item\hypertarget{li-481}{}\(|X| = |Y|\), \(X\) and \(Y\) are finite, and \(f\) is injective but not surjective.%
\item\hypertarget{li-482}{}\(|X| = |Y|\), \(X\) and \(Y\) are finite, and \(f\) is surjective but not injective.%
\end{enumerate}
%
\par\smallskip
\item[13.]\hypertarget{exercise-59}{}\hypertarget{p-718}{}%
...
\item[14.]\hypertarget{exercise-60}{}\hypertarget{p-730}{}%
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-497}{}\hypertarget{p-731}{}%
Is \(f\) injective? Prove your answer.%
\item\hypertarget{li-498}{}\hypertarget{p-732}{}%
Is \(f\) surjective? Prove your answer.%
\end{enumerate}
%
\par\smallskip
\item[15.]\hypertarget{exercise-61}{}\hypertarget{p-738}{}%
...
\par\smallskip
\item[16.]\hypertarget{exercise-62}{}\hypertarget{p-740}{}%
...
\par\smallskip
\item[17.]\hypertarget{exercise-63}{}\hypertarget{p-742}{}%
