...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-443}{}\(f:\N \to \N\) given by \(f(n) = n+4\).%
\item\hypertarget{li-444}{}\(f:\Z \to \Z\) given by \(f(n) = n+4\).%
\item\hypertarget{li-445}{}\(f:\Z \to \Z\) given by \(f(n) = 5n - 8\).%
\item\hypertarget{li-446}{}\(f:\Z \to \Z\) given by \(f(n) = \begin{cases}n/2 \amp  \text{ if } n \text{ is even} \\ (n+1)/2 \amp \text{ if } n \text{ is odd} . \end{cases}\)%
\end{enumerate}
%
\par\smallskip
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-451}{}\hypertarget{p-700}{}%
Is \(f\) injective? Prove your answer.%
\item\hypertarget{li-452}{}\hypertarget{p-701}{}%
Is \(f\) surjective? Prove your answer.%
\item\hypertarget{li-453}{}\hypertarget{p-702}{}%
Find \(f\inv(1)\).%
\item\hypertarget{li-454}{}\hypertarget{p-703}{}%
Find \(f\inv(0)\).%
\item\hypertarget{li-455}{}\hypertarget{p-704}{}%
Find \(f\inv(12)\).%
\end{enumerate}
%
\par\smallskip
\item[7.]\hypertarget{exercise-53}{}\hypertarget{p-711}{}%
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-461}{}\hypertarget{p-712}{}%
Find \(f\inv(3)\).%
\item\hypertarget{li-462}{}\hypertarget{p-713}{}%
Find \(f\inv(28)\).%
\item\hypertarget{li-463}{}\hypertarget{p-714}{}%
Is \(f\) injective. Explain.%
\item\hypertarget{li-464}{}\hypertarget{p-715}{}%
Is \(f\) surjective. Explain.%
\end{enumerate}
%
\par\smallskip
\item[8.]\hypertarget{exercise-54}{}\hypertarget{p-719}{}%
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-469}{}\hypertarget{p-720}{}%
Find \(f\inv(2)\).%
\item\hypertarget{li-470}{}\hypertarget{p-721}{}%
Give a geometric description of \(f\inv(n)\) for any \(n \ge 1\).%
\item\hypertarget{li-471}{}\hypertarget{p-722}{}%
Find a formula for \(|f\inv(n)|\) in terms of \(n\).%
\end{enumerate}
%
\par\smallskip
\item[9.]\hypertarget{exercise-55}{}\hypertarget{p-727}{}%
Let \(f:X \to Y\) be some function. Suppose \(3 \in Y\). What can you say about \(f\inv(3)\) if you know, \leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-475}{}\hypertarget{p-728}{}%
\(f\) is injective? Explain.%
\item\hypertarget{li-476}{}\hypertarget{p-729}{}%
\(f\) is surjective? Explain.%
\item\hypertarget{li-477}{}\hypertarget{p-730}{}%
\(f\) is bijective? Explain.%
\end{enumerate}
%
\par\smallskip
\item[10.]\hypertarget{exercise-56}{}\hypertarget{p-735}{}%
Find a set \(X\) and a function \(f:X \to \N\) so that \(f\inv(0) \cup f\inv(1) = X\).%
\par\smallskip
\item[11.]\hypertarget{exercise-57}{}\hypertarget{p-737}{}%
What can you deduce about the sets \(X\) and \(Y\) if you know \textellipsis{} \leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-481}{}\hypertarget{p-738}{}%
there is an injective function \(f:X \to Y\)? Explain.%
\item\hypertarget{li-482}{}\hypertarget{p-739}{}%
...
%
\par\smallskip
\item[12.]\hypertarget{exercise-58}{}\hypertarget{p-745}{}%
Suppose \(f:X \to Y\) is a function. Which of the following are possible? Explain. \leavevmode%
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-487}{}\(f\) is injective but not surjective.%
\item\hypertarget{li-488}{}\(f\) is surjective but not injective.%
\item\hypertarget{li-489}{}\(|X| = |Y|\) and \(f\) is injective but not surjective.%
\item\hypertarget{li-490}{}\(|X| = |Y|\) and \(f\) is surjective but not injective.%
\item\hypertarget{li-491}{}\(|X| = |Y|\), \(X\) and \(Y\) are finite, and \(f\) is injective but not surjective.%
\item\hypertarget{li-492}{}\(|X| = |Y|\), \(X\) and \(Y\) are finite, and \(f\) is surjective but not injective.%
\end{enumerate}
%
\par\smallskip
\item[13.]\hypertarget{exercise-59}{}\hypertarget{p-753}{}%
...
\item[14.]\hypertarget{exercise-60}{}\hypertarget{p-765}{}%
...
\begin{enumerate}[label=(\alph*)]
\item\hypertarget{li-507}{}\hypertarget{p-766}{}%
Is \(f\) injective? Prove your answer.%
\item\hypertarget{li-508}{}\hypertarget{p-767}{}%
Is \(f\) surjective? Prove your answer.%
\end{enumerate}
%
\par\smallskip
\item[15.]\hypertarget{exercise-61}{}\hypertarget{p-773}{}%
...
\par\smallskip
\item[16.]\hypertarget{exercise-62}{}\hypertarget{p-775}{}%
...
\par\smallskip
\item[17.]\hypertarget{exercise-63}{}\hypertarget{p-777}{}%
...
\par\smallskip
\item[18.]\hypertarget{exercise-64}{}\hypertarget{p-779}{}%
...
\hypertarget{p-780}{}%
To finde the recurrence relation, consider how many \emph{new} handshakes occure when person \(n+1\) enters the room.%
\end{exerciselist}
\end{document}