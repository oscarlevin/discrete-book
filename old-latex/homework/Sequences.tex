...
\question Let $a_n$ be the number of  $1 \times n$ tile designs you can make using $1 \times 1$ squares available in 4 colors and $1 \times 2$ dominoes available in 5 colors.
\begin{parts}
