...
\firstpageheader{Math 228}{\bf Fun with Sums}{Spring 2013}
...
\begin{questions}
  ...
  \begin{multicols}{2}
    \begin{parts} 
      \part $n = 1$: $1 = 1$
      \vskip 1em
      \part $n = 2$: $1 + 3 = \underline{\qquad}$
      \vskip 1em
      \part $n = 3$: $1 + 3 + 5 = \underline{\qquad}$
      \vskip 1em
      \part $n = 4$: \underline{\hspace{1.3in}} = \underline{\qquad}
      \vskip 1em
      \part $n = 5$: \underline{\hspace{1.5in}} = \underline{\qquad}
      \vskip 1em
      \part $n = 6$: \underline{\hspace{1.7in}} = \underline{\qquad}
    \end{parts}
...
\begin{center}
 \noindent 1 dot \qquad\qquad 4 dots \qquad\qquad\quad 9 dots \qquad\qquad\qquad 16 dots \qquad\qquad\qquad 25 dots  
  \end{center}
  ...
  \begin{center}
 \noindent 1 dot \qquad\qquad 3 dots \qquad\qquad\quad 6 dots \qquad\qquad\qquad 10 dots \qquad\qquad\qquad 15 dots  
  \end{center}
...
\subsection*{Activity 4: Triangles, Squares, and Cubes - oh my!}
Our goal: We have seen what happens when we add up odd numbers and positive integers.  What happens when we add up perfect cubes?

\begin{questions}
  \question Begin by gathering some data:
  \begin{multicols}{2}
    $1^3 =$
    \vskip 1em
    $1^3 + 2^3 =$
  ...
  \vskip 2em
  \question Make a conjecture.  Again, write your conjecture both as an English sentence and an equation.
  \vfill
  \question What does your conjecture say the sum of the first 7 cubes should be?  Check your answer.
  \vfill
  \question How convinced are you that your conjecture is correct?  How would you convince a skeptical friend that you are correct?  Yes, that skeptical friend is you!
  \vfill
\end{questions}
