...
\def\thetitle{Counting: Conclusion} % will be put in the center header on the first page only.
...
\section{Chapter Summary}\label{sec:count-conc}
\begin{activity}
\begin{questions}
\question Suppose you have a huge box of animal crackers containing plenty of each of 10 different animals.  For the counting questions below, carefully examine their similarities and differences, and then give an answer.  The answers are all one of the following:
...
\begin{parts}
\part How many animal parades containing 6 crackers can you line up?
