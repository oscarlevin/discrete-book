...
\begin{itemize}
 \item $P \wedge Q$ means  $P$ and $Q$, called a {\em conjunction}\index{conjunction}\index{connectives!and}.
\item $P \vee Q$ means $P$ or $Q$, called a {\em disjunction}\index{disjunction}\index{connectives!or}.
\item $P \imp Q$ means if $P$ then $Q$, called an {\em implication} or {\em conditional}\index{implication}\index{conditional}\index{connectives!implies}\index{if\ldots then}.
\item $P \iff Q$ means $P$ if and only if $Q$, called a {\em biconditional}\index{biconditional}\index{connectives!if and only if}\index{if and only if}.
\item $\neg P$ means not $P$, called a {\em negation}\index{negation}\index{connectives!not}.
\end{itemize}
\end{defbox}
