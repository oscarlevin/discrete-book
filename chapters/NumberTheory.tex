...
\vskip 1ex
\noindent If $d$ and $n$ have no common factors\footnote{If two numbers have no common factors, they are said to be {\em relatively prime}} then $\gcd(d,n) = 1$, so $a \equiv b \pmod n$.
\end{defbox}
