...
\heading{Math 228}{}{Binomial Identities Notes}
...
Hopefully this gives some idea of how explanatory proofs of binomial identities can go.  It is worth pointing out that sometimes more traditional proofs are also nice.  Most every binomial identity can be proved using mathematical induction, using the recursive definition for ${n \choose k}$.  Additionally, consider the following rather slick proof of the last identity.
