...
\firstpageheader{Math 228}{\bf Binomial Identities}{March 28, 2012}
...
\begin{parts}
  ...
  \vfill
  \part What are the two different ways to compute the number of ways your team can win?  What binomial identity is this an example of?
  \vfill
\end{parts}
\question Generalize.  That is, what if the rules changed and you played a best of $2n-1 $ tournament?  What binomial identity to you get?
\vfill
