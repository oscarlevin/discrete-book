...
\end{parts}
  ...
  \begin{answer}
    \begin{parts}
      ...
      \part All of them, except the parallelograms.  So \[{7\choose 2}{7\choose 2} - \left[ {7 \choose 2} + \left({7 \choose 2}-1\right) + \left({7 \choose 2} - 3\right) + \left({7 \choose 2} - 6\right) + \left({7 \choose 2} - 10\right) + \left({7 \choose 2} - 15\right) \right].\]
    \end{parts}
  \end{answer}
