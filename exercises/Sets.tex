...
\begin{parts}
 ...
 \part Find $A \times C$.
 \part Is $C \subseteq A$?  Explain.
 \part Is $C \subseteq B$?  Explain.
\end{parts}
...
\begin{parts}
  \part Is $\Z^+ \subseteq 2\Z$?  Explain.
  \part Is $2\Z \subseteq \Z^+$?  Explain.
  \part Find $2\Z \cap 3\Z$.  Describe the set in words, and also in symbols (using a $\st$ symbol).  %fix!
...
\begin{parts}
  \part $|A|$ when $A = \{4,5,6,\ldots,37\}$
  \part $|A|$ when $A = \{x \in \Z \st -2 \le x \le 100\}$
  \part $|A \cap B|$ when $A = \{x \in \N \st x \le 20\}$ and $B = \{x \in \N \st x \mbox{ is prime}\}$
\end{parts}
...
%For this one, we should add a 4th element, as this example is done in the chapter.
