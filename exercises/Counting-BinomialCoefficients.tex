...
\begin{parts}
  ...
  \part How many subsets have $\{2,3,5\}$ as a subset?
...
\begin{parts}
  ...
  \part How many subsets of cardinality 4 have $\{2,3,5\}$ as a subset?
%  \part How many subsets of $S$ contain no prime numbers?
...
\begin{parts}
\part You find yourself making rows containing an equal number of pennies and nickels.  For fun, you decide to lay out every possible such row.  How many coins will you need?

\part How many coins would you need to make all possible rows of 6 coins (not necessarily with equal number of pennies and nickels)?
\end{parts}
...
\part How many choices do you have for your pizza if you \emph{insist} on having pineapple as one of your toppings?
