...
\question A \emph{multiset} is a collection of objects, just like a set, but can contain an object more than once (the order of the elements still doesn't matter).  For example, $\{1,1, 2, 5, 5, 7\}$ is a multiset of size 6.
\begin{parts}
...
\question After gym class you are tasked with putting the 14 identical dodgeballs away into 5 bins.
\begin{parts}
  \part How many ways can you do this if there are no restrictions?
  \part How many ways can you do this if each bin must contain at least one dodgeball?
...
\begin{parts}
	...
	\part How many solutions in non-negative integers are there to $x+y+z = 8$?
