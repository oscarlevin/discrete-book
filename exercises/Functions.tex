...
\question Let $A = \{1,2,3,\ldots,10\}$.  Consider the function $f:\pow(A) \to \N$ given by $f(B) = |B|$.  That is, $f$ takes a subset of $A$ as an input and outputs the cardinality of that set.
\begin{parts}
...
\question What can you deduce about the sets $X$ and $Y$ if you know\ldots
\begin{parts}
  \part there is an injective function $f:X \to Y$?  Explain.
  \part there is a surjective function $f:X \to Y$?  Explain.
  \part there is a bijectitve function $f:X \to Y$?  Explain.
\end{parts}
