...
\begin{parts}
  \part How many couples danced if every girl dances with every boy?
...
\question For each part below, say whether the statement is true or false.  Explain why the true statements are true, and give counterexamples for the false statements.
\begin{parts}
