...
\firstpageheader{Math 228}{\bf Practice Problems 4: Sequences \\ Hints and Answers}{Spring 2012}
...
%Write out the first few terms of the sequence given by $a_1 = 3$; $a_n = 2a_{n-1} + 4$.  Then find a recursive formula for the sequence $10, 24, 52, 108, \ldots$.
\question $3, 10, 24, 52, 108,\ldots$.  The recursive definition for $10, 24, 52, \ldots$ is $a_n = 2a_{n-1} + 4$ with $a_1 = 10$.
...
% Find $x$ and $y$ such that $27, x, y, 1$ is part of an arithmetic progression.  Then find $x$ and $y$ so that the sequence is part of a geometric progression.  ($x$ and $y$ might not be integers.) 
...
\end{parts}
 ...
 % Can you use polynomial fitting to find the formula for the $n$th term of the sequence 4, 7, 11, 18, 29, 47, \ldots?  Explain why or why not. 
...
\question 171 and 341.  $a_n = a_{n-1} + 2a_{n-2}$ with $a_0 = 3$ and $a_1 = 5$.  Closed formula: $a_n = \frac{8}{3}2^n + \frac{1}{3}(-1)^n$
...
\question The general solution is $a_n = a + bn$ where $a$ and $b$ depend on the initial conditions.  %Solve the recurrence relation $a_n = 2a_{n-1} - a_{n-2}$.
\begin{parts}
  \part $a_n = 1 + n$
