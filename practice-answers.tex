\clearpage\noindent{\bf Solutions for Chapter 1} \heading{}{}{Chapter 1\ Solutions} \begin{itemize}
\begin{ans}{1.1.}
 \begin{tabular}{c|c|c}
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter 2} \heading{}{}{Chapter 2\ Solutions} \begin{itemize}
\begin{ans}{2.1.}
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter 3} \heading{}{}{Chapter 3\ Solutions} \begin{itemize}
\begin{ans}{3.1.}
    255.
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter 4} \heading{}{}{Chapter 4\ Solutions} \begin{itemize}
\begin{ans}{4.1.}
		\begin{parts}
		%$2, 5, 10, 17, 26, \ldots$
		  \part $a_n = n^2 + 1$
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter 5} \heading{}{}{Chapter 5\ Solutions} \begin{itemize}
\begin{ans}{5.1.}
		\begin{proof}
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter 6} \heading{}{}{Chapter 6\ Solutions} \begin{itemize}
\begin{ans}{6.1.}
		\begin{proof}
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter C.1} \heading{}{}{Chapter C.1\ Solutions} \begin{itemize}
\begin{ans}{C.1.}
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter C.2} \heading{}{}{Chapter C.2\ Solutions} \begin{itemize}
\begin{ans}{C.1.}
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter C.3} \heading{}{}{Chapter C.3\ Solutions} \begin{itemize}
\begin{ans}{C.1.}
		\begin{parts}
...
\end{ans}
\end{itemize}
\clearpage\noindent{\bf Solutions for Chapter C.4} \heading{}{}{Chapter C.4\ Solutions} \begin{itemize}
\begin{ans}{C.1.}
