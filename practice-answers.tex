 \protect \vskip 2em \protect \subsection *{Solutions for Section 0.2} \protect \markright {Solutions for 0.2} \par \protect \begin {itemize} 
\begin{ans}{0.2.1.}
    \begin{parts}
	...
	\part $A \times C = \{(1,2), (1,3), (1,5), (2,2), (2,3), (2,5), (3,2), (3,3), (3,5),$\\ $ (4,2), (4,3), (4,5), (5,2), (5,3), (5,5)\}$.
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 0.3} \protect \markright {Solutions for 0.3} \par \protect \begin {itemize} 
\begin{ans}{0.3.1.}
...
\begin{ans}{0.3.7.}
		...
		%   Use one of the parts above to prove that $f$ is not surjective.
		  \part Part (b) proves that $f$ is not surjective -- there is an element of the codomain (28) which is not assigned to any inputs.
		\end{parts}
...
\begin{ans}{0.3.8.}
		\begin{parts}
			...
			\part $|f\inv(3)| \ge 1$.  In other words, $f\inv(3)$ is a set containing at least one element, possibly more.  Surjective functions must have something map to 3.%$f$ is surjective? Explain.
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 1.1} \protect \markright {Solutions for 1.1} \par \protect \begin {itemize} 
\begin{ans}{1.1.1.}
    255.
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 1.2} \protect \markright {Solutions for 1.2} \par \protect \begin {itemize} 
\begin{ans}{1.2.1.}
    \begin{parts}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 1.3} \protect \markright {Solutions for 1.3} \par \protect \begin {itemize} 
\begin{ans}{1.3.1.}
    \begin{parts}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 1.4} \protect \markright {Solutions for 1.4} \par \protect \begin {itemize} 
\begin{ans}{1.4.1.}
		\begin{proof}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 1.5} \protect \markright {Solutions for 1.5} \par \protect \begin {itemize} 
\begin{ans}{1.5.1.}
		\begin{parts}
...
\begin{ans}{1.5.3.}
	 \begin{parts}
	   ...
	   \part ${13 \choose 4}$.  First put one ball in each bin.  This leaves 9 stars and 4 bars.%How many ways can you do this if each bin must contain at least one dodgeball?
...
\end{ans}
\begin{ans}{1.5.6.}
	${10 \choose 5}$.  We have 5 stars (the five dice) and 5 bars (the five switches between the numbers 1-6).
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 1.6} \protect \markright {Solutions for 1.6} \par \protect \begin {itemize} 
\begin{ans}{1.6.1.}
  Hint: Stars and bars.
   \begin{parts}
    \part ${9 \choose 6}$.
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 1.7} \protect \markright {Solutions for 1.7} \par \protect \begin {itemize} 
\begin{ans}{1.7.1.}
	There are 8 different functions.  For example, $f(1) = a$, $f(2) = a$, $f(3) = a$; or $f(1) = a$, $f(2) = b$, $f(3) = a$, and so on.  None of the functions are injective.  Exactly 6 of the functions are surjective.  No functions are both (since no functions here are injective).
...
\end{ans}
\begin{ans}{1.7.6.}
	$5! - \left[{5 \choose 1}4! - {5 \choose 2}3! + {5 \choose 3}2! - {5 \choose 4}1! + {5 \choose 5}0!\right]$.  This is a sneaky way to ask for the number of derangements on 5 elements. %Let $A = \{1,2,3,4,5\}$.  How many injective functions $f:A \to A$ have the property that for each $x \in A$, $f(x) \ne x$?
	
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 1.8} \protect \markright {Solutions for 1.8} \par \protect \begin {itemize} 
\begin{ans}{1.8.1.}
	\begin{parts}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 2.1} \protect \markright {Solutions for 2.1} \par \protect \begin {itemize} 
\begin{ans}{2.1.1.}
		\begin{parts}
		%$2, 5, 10, 17, 26, \ldots$
		  \part $a_n = n^2 + 1$.
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 2.2} \protect \markright {Solutions for 2.2} \par \protect \begin {itemize} 
\begin{ans}{2.2.1.}
		\begin{parts}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 2.3} \protect \markright {Solutions for 2.3} \par \protect \begin {itemize} 
\begin{ans}{2.3.1.}
		\begin{parts}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 2.4} \protect \markright {Solutions for 2.4} \par \protect \begin {itemize} 
\begin{ans}{2.4.1.}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 2.5} \protect \markright {Solutions for 2.5} \par \protect \begin {itemize} 
\begin{ans}{2.5.1.}
		\begin{proof}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 2.6} \protect \markright {Solutions for 2.6} \par \protect \begin {itemize} 
\begin{ans}{2.6.1.}
...
\end{ans}
\begin{ans}{2.6.16.}
		Note that $1 = 2^0$; this is your base case.  Now suppose $k$ can be written as the sum of distinct powers of 2 for all $1\le k < n$.  We can then write $n$ as the sum of distinct powers of 2 as follows: subtract the largest power of 2 less than $n$ from $n$.  That is, write $n = 2^j + k$ for the largest possible $j$.  But $k$ is now less than $n$, and also less than $2^j$, so write $k$ as the sum of distinct powers of 2 (we can do so by the inductive hypothesis).  Thus $n$ can be written as the sum of distinct powers of 2 for all $n \ge 1$.
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 3.2} \protect \markright {Solutions for 3.2} \par \protect \begin {itemize} 
\begin{ans}{3.2.1.}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 3.3} \protect \markright {Solutions for 3.3} \par \protect \begin {itemize} 
\begin{ans}{3.3.1.}
     \begin{parts}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 3.4} \protect \markright {Solutions for 3.4} \par \protect \begin {itemize} 
\begin{ans}{3.4.1.}
     \begin{parts}
 	\part For all integers $a$ and $b$, if $a$ or $b$ is not even, then $a+b$ is not even.
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 3.5} \protect \markright {Solutions for 3.5} \par \protect \begin {itemize} 
\begin{ans}{3.5.1.}
...
\begin{ans}{3.5.5.}
	\begin{parts}
	  ...
	  \part Negation: There are integers $x$ and $y$ such that for every integer $n$, $x > 0$ and $nx \le y$. \\
...
\begin{ans}{3.5.6.}
	...
	\part The statement is true.  If $n$ is an even integer less than or equal to 7, then the only way it could not be negative is if $n$ was equal to 0, 2, 4, or 6.
	...
	\part For all integers $n$, if $n$ is negative or $n \in \{0,2,4,6\}$ then $n$ is even and $n \le 7$.  This is false.  $n = -3$ is a counterexample.
      \end{parts}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 4.1} \protect \markright {Solutions for 4.1} \par \protect \begin {itemize} 
\begin{ans}{4.1.1.}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 4.2} \protect \markright {Solutions for 4.2} \par \protect \begin {itemize} 
\begin{ans}{4.2.1.}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 4.3} \protect \markright {Solutions for 4.3} \par \protect \begin {itemize} 
\begin{ans}{4.3.1.}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 4.4} \protect \markright {Solutions for 4.4} \par \protect \begin {itemize} 
\begin{ans}{4.4.1.}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section 4.6} \protect \markright {Solutions for 4.6} \par \protect \begin {itemize} 
\begin{ans}{4.6.1.}
...
\begin{ans}{4.6.14.}
		...
		\begin{parts}
			...
			\part The planar dual of the dodecahedron is itself a planar graph.  Thus by the 4-color theorem, it can be colored using only 4 colors without two adjacent vertices (corresponding to the faces of the polyhedron) being colored identically.
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section A.1} \protect \markright {Solutions for A.1} \par \protect \begin {itemize} 
\begin{ans}{A.1.1.}
		\begin{parts}
...
\begin{ans}{A.1.3.}
		\begin{parts}
		  ...
		  \part The triangular numbers are the sum of the first $n$ numbers $1,2,3,4, \ldots$.  To get the sequence of partial sums, we multiply by $\frac{1}{1-x}$. This gives the correct generating function again. %Multiply two known generating functions.
		\end{parts}
...
\begin{ans}{A.1.13.}
		\begin{parts}
		  ...
		  \part $1, 2, 4, 7, 12, 20, \ldots$.  %$\frac{1}{(1-x-x^2)(1-x)}$
		\end{parts}
...
\end{ans}
\protect \end {itemize}
 \protect \vskip 2em \protect \subsection *{Solutions for Section A.2} \protect \markright {Solutions for A.2} \par \protect \begin {itemize} 
\begin{ans}{A.2.1.}
		\begin{proof}
