...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Section 2.6} \protect \heading {}{}{Section 2.6\ Solutions} \protect \begin {itemize}
\begin{ans}{2.6.1.}
	There are 8 different functions.  For example, $f(1) = a$, $f(2) = a$, $f(3) = a$; or $f(1) = a$, $f(2) = b$, $f(3) = a$, and so on.  None of the functions are injective.  Exactly 6 of the functions are surjective.  No functions are both (since no functions here are injective).
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Section 2.7} \protect \heading {}{}{Section 2.7\ Solutions} \protect \begin {itemize}
\begin{ans}{2.7.1.}
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Section 3.5} \protect \heading {}{}{Section 3.5\ Solutions} \protect \begin {itemize}
\begin{ans}{3.5.1.}
		\begin{proof}
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Section 5.1} \protect \heading {}{}{Section 5.1\ Solutions} \protect \begin {itemize}
\begin{ans}{5.1.1.}
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Section 5.2} \protect \heading {}{}{Section 5.2\ Solutions} \protect \begin {itemize}
\begin{ans}{5.2.1.}
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Section 5.3} \protect \heading {}{}{Section 5.3\ Solutions} \protect \begin {itemize}
\begin{ans}{5.3.1.}
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Section 5.4} \protect \heading {}{}{Section 5.4\ Solutions} \protect \begin {itemize}
\begin{ans}{5.4.1.}
