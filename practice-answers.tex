 \noindent{\textbf {Solutions for Section 0.2}} \begin{itemize} 
\begin{ans}{0.2.1.}
    \begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 0.3}} \begin{itemize} 
\begin{ans}{0.3.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 1.1}} \begin{itemize} 
\begin{ans}{1.1.1.}
    255.
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 1.2}} \begin{itemize} 
\begin{ans}{1.2.1.}
    \begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 1.3}} \begin{itemize} 
\begin{ans}{1.3.1.}
    \begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 1.4}} \begin{itemize} 
\begin{ans}{1.4.1.}
		\begin{proof}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 1.5}} \begin{itemize} 
\begin{ans}{1.5.1.}
		\begin{parts}
			\part ${10\choose 5}$ -- we must select 5 of the 10 digits to put in the set.
			\part Use stars and bars: each star represents one of the 5 elements of the set, each bar represents a switch between digits.  So there are 5 stars and 9 bars, giving us ${14 \choose 5}$.
		\end{parts}
...
\begin{ans}{1.5.5.}
	\begin{parts}
		...
		\part This requires stars and bars.  Use a star to represent each of the 5 digits in the number, and use their position relative to the bars to say what numeral fills that spot.  So we will have 5 stars and 6 bars, giving ${11 \choose 5}$.
	\end{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 1.6}} \begin{itemize} 
\begin{ans}{1.6.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 1.7}} \begin{itemize} 
\begin{ans}{1.7.1.}
	There are 8 different functions.  For example, $f(1) = a$, $f(2) = a$, $f(3) = a$; or $f(1) = a$, $f(2) = b$, $f(3) = a$, and so on.  None of the functions are injective.  Exactly 6 of the functions are surjective.  No functions are both (since no functions here are injective).
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 1.8}} \begin{itemize} 
\begin{ans}{1.8.1.}
	\begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 2.1}} \begin{itemize} 
\begin{ans}{2.1.1.}
		\begin{parts}
		%$2, 5, 10, 17, 26, \ldots$
		  \part $a_n = n^2 + 1$
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 2.2}} \begin{itemize} 
\begin{ans}{2.2.1.}
		\begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 2.3}} \begin{itemize} 
\begin{ans}{2.3.1.}
		\begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 2.4}} \begin{itemize} 
\begin{ans}{2.4.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 2.5}} \begin{itemize} 
\begin{ans}{2.5.1.}
		\begin{proof}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 2.6}} \begin{itemize} 
\begin{ans}{2.6.1.}
		\begin{parts}
		%$2, 5, 10, 17, 26, \ldots$
		  \part $a_n = n^2 + 1$
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 3.1}} \begin{itemize} 
\begin{ans}{3.1.1.}
    \begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 3.2}} \begin{itemize} 
\begin{ans}{3.2.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 3.3}} \begin{itemize} 
\begin{ans}{3.3.1.}
     \begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 3.4}} \begin{itemize} 
\begin{ans}{3.4.1.}
     \begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 3.5}} \begin{itemize} 
\begin{ans}{3.5.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 4.1}} \begin{itemize} 
\begin{ans}{4.1.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 4.2}} \begin{itemize} 
\begin{ans}{4.2.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 4.3}} \begin{itemize} 
\begin{ans}{4.3.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 4.4}} \begin{itemize} 
\begin{ans}{4.4.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section 4.6}} \begin{itemize} 
\begin{ans}{4.6.1.}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section A.1}} \begin{itemize} 
\begin{ans}{A.1.1.}
		\begin{parts}
...
\end{ans}
\end{itemize}
 \noindent{\textbf {Solutions for Section A.2}} \begin{itemize} 
\begin{ans}{A.2.1.}
		\begin{proof}
