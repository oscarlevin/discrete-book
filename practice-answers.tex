\protect \clearpage \protect \noindent {\protect \bf  Solutions for Chapter 1} \protect \heading {}{}{Chapter 1\ Solutions} \protect \begin {itemize}
\begin{ans}{1.1.}
    \begin{parts}
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Chapter 2} \protect \heading {}{}{Chapter 2\ Solutions} \protect \begin {itemize}
\begin{ans}{2.1.}
    255.
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Chapter 3} \protect \heading {}{}{Chapter 3\ Solutions} \protect \begin {itemize}
\begin{ans}{3.1.}
		\begin{parts}
		%$2, 5, 10, 17, 26, \ldots$
		  \part $a_n = n^2 + 1$
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Chapter 4} \protect \heading {}{}{Chapter 4\ Solutions} \protect \begin {itemize}
\begin{ans}{4.1.}
    \begin{parts}
...
\end{ans}
\protect \end {itemize}
\protect \clearpage \protect \noindent {\protect \bf  Solutions for Chapter 5} \protect \heading {}{}{Chapter 5\ Solutions} \protect \begin {itemize}
\begin{ans}{5.1.}
