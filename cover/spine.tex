...
\usepackage{tikz}
\usepackage{mdframed}
\usepackage[papersize={9.25in,1in}, hmargin={.75in, .75in}]{geometry}
...
~
\vfill
{\color{bg!65} \LARGE \scshape Levin}\hfill \resizebox{.6\linewidth}{!}{\scshape Discrete Mathematics} \hfill {\color{bg!65} \LARGE \scshape 2nd ed.}
