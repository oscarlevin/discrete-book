...
\usepackage{tikz}
\usepackage{mdframed}
\usepackage[papersize={10.25in,1in}, hmargin={.5in, .5in}]{geometry}
...
{\color{bg!10} \LARGE \scshape Levin}\hfill \resizebox{.4\linewidth}{!}{\scshape Discrete Mathematics} \hfill {\color{bg!10} \LARGE \scshape 3rd ed.}

\centerline{
\hspace{0em} \tikz[scale=0.4,yscale=.5]{
