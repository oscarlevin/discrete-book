...
\firstpageheader{Math 228}{\bf Homework 2}{} %Due: Wed Jan 30, 2013}
...
\begin{parts}
  \part Are the statements $P \vee (Q \wedge R)$ and $(P \vee Q) \wedge  (P \vee R)$ logically equivalent?  
  \begin{solution}
    Yes they are.  We prove this by showing that their truth tables are identical:
    \begin{center}
        \begin{tabular}{c|c|c||c||c}
    $P$ & $Q$ & $R$ & $P \vee (Q \wedge  R)$ & $(P \vee Q) \wedge  (P \vee R)$\\ \hline
    T & T & T & T & T\\
    T & T & F & T & T \\
    T & F & T & T & T \\
    T & F & F & T & T \\
  ...
  \part Are the statements $P \wedge  (Q \vee R)$ and $(P \wedge  Q) \vee (P \wedge  R)$ logically equivalent?
  \begin{solution}
...
% \end{center}
% \begin{solution}
%   One possible statement is this: $\neg Q \vee (\neg P \wedge  R)$.  Of course, there are many statements logically equivalent to this such as $Q \imp (\neg P \wedge  R)$ or $Q \imp \neg(R \imp P)$.  
%   
