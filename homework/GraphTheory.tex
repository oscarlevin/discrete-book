...
\begin{itemize}
\item[$G_1$:] $V_1=\{a,b,c,d,e,f,g\}$\\ $E_1=\{\{a,b\},\{a,d\},\{b,c\},\{b,d\},\{b,e\},\{b,f\},\{c,g\},\{d,e\},\{e,f\},\{f,g\}\}$.
\item[$G_2$:] $V_2=\{v_1,v_2,v_3,v_4,v_5,v_6,v_7\}$,\\ $E_2=\{\{v_1,v_4\},\{v_1,v_5\},\{v_1,v_7\},\{v_2,v_3\},\{v_2,v_6\},\{v_3,v_5\},\{v_3,v_7\},$\\
	$\{v_4,v_5\},\{v_5,v_6\},\{v_5,v_7\}\}$
\end{itemize}
...
\question Prove that the {\em Petersen graph}\index{Petersen graph} (below) is not planar.  Hint: what is the length of the shortest cycle?
...
\begin{parts}
  ...
  \begin{solution}
    ...
    \begin{center}
      \begin{tikzpicture}
        \draw (-1,0) \v -- (0,1) \v -- (1, 0) \v -- (0, .33) \v -- (-1,0) -- (0,-.33) \v -- (1,0) -- (0,-1) \v -- (-1,0);
      \end{tikzpicture}
      \hspace{1in}
      \begin{tikzpicture}
        \draw (270:.5) \v -- (255:1) \v -- (285:1) \v -- (270:.5) -- (0,0) \v -- (135:.5) \v -- (150:1) \v -- (120:1) \v -- (135:.5) (0,0) -- (45:.5) \v -- (60:1) \v -- (30:1) \v -- (45:.5);
      \end{tikzpicture}
